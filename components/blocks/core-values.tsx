          ...
          <div className='flex gap-3 max-md:flex-wrap lg:gap-10'>
            {coreValues.map((item, index) => (
              <div
                ...
                className='flex overflow-hidden animate__animated animate__fadeIn p-[0.5px] flex-col w-full md:w-1/2 lg:w-1/3  text-center transition-all cursor-pointer shadow-2xl bg-gradient-to-bl from-neutral-700 to-neutral-950 hover:[box-shadow:#f5a4c0_0px_13px_50px_-26px] shadow-white/20 hover:-translate-y-6 bg-black-900/30 rounded-xl'
                style={{
