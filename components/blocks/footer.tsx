        ...
        <div className='pb-24 border-b border-gray-900'>
          <div className='flex flex-wrap -m-8'>
              ...
              <div className='lg:max-w-sm'>
                ...
                {/* <div className='flex flex-wrap -m-1.5'>
                  <div className='w-auto p-1.5'>
                    <a href='#'>
                      <div className='flex items-center justify-center border border-gray-800 rounded-full w-9 h-9 hover:border-gray-900'>
                        <svg
                          width={9}
                          height={16}
                          viewBox='0 0 9 16'
            ...
            <div className='w-full md:p-8 sm:w-1/2 lg:w-2/12'>
              <h3 className='mb-8 text-sm font-semibold leading-normal text-gray-600 uppercase tracking-px'>
                Products
              </h3>
              <ul>
                <li className='mb-5'>
