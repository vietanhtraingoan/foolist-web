...
const HeroSection = ({
  ...
  return (
    <Section
      id='first-section'
      className={`${classNamePrefix}__introduction-container !pt-0 !mt-0`}
    >
      <div
        className={clsx(
          'h-[80vh] grid items-center w-full grid-cols-1 lg:grid-cols-2 py-12 justify-center lg:justify-start'
        )}
      >
        <div className='flex flex-col max-md:mb-12'>
          <div
          ...
          <div
            className={clsx(
              'max-w-xl leading-relaxed animate__animated animate__fadeInUp tracking-tight text-center md:text-left text-gray-400 text-lg prose max-md:pr-0 max-xl:pr-10'
            )}
          >
            <p>{paragraph}</p>
          </div>
        ...
        <div className='relative xl:ml-auto xl:pl-8 rounded-xl animate__animated animate__zoomIn'>
