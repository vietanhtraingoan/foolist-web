          ...
          {services.map((item, index: number) => {
            return (
              <div
                ...
                className={clsx(
                  'relative p-[1px] cursor-pointer group z-[1] before:absolute before:blur-[10px] before:translate-y-2 before:content-[""] hover:before:bg-primary/30 transition-all before:bg-gray-500/20 before:z-[-2] before:inset-[-8px] bg-gradient-to-t from-gray-100 to-gray-500 h-full rounded-2xl',
                  {
              ...
              >
                <div className='w-full h-full overflow-hidden bg-transparent rounded-2xl'>
                  ...
                  <div className='relative bg-gradient-to-t from-black/40 to-transparent z-[1] flex flex-col justify-end h-full p-8'>
                    <h3
                      className={clsx(
                        'cursor-pointer text-white font-heading',
